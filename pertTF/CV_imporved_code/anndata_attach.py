...
original_h5ad = 'preprocessed_hvg3000.object_integrated_assay3_annotated_final.modified.cleaned.updated.celltype2_only.h5ad'
#new_h5ad = 'preprocessed_hvg3000.modified.object_integrated_assay3_annotated_final.cleaned.updated.h5ad'
...
if 'celltype' in adata.obs.columns:
    ...
    print("Column 'celltype' does not exist yet. Creating placeholder.")
