...
# --- 1. SETUP ---
H5AD_PATH = "/local/projects-t3/lilab/vmenon/Pert-TF-model/pertTF/Independet_test_data/reanalysis_18_clones/18clones_cleaned_final.h5ad"
MODEL_DIR = Path("/local/projects-t3/lilab/vmenon/Pert-TF-model/pertTF/CV_imporved_code_second_time/Identity_complete/fold_1")
