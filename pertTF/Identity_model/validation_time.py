...
# CONFIG – EDIT THESE
# --------------------
INPUT_PATH = "/local/projects-t3/lilab/vmenon/Pert-TF-model/pertTF/Identity_model/fold_5/best_epoch_e34/adata_with_collapsed_preds.h5ad"
OUTDIR     = "/local/projects-t3/lilab/vmenon/Pert-TF-model/pertTF/Identity_model/fold_5/best_epoch_e34/VAL_PDFS_BY_TIME"
...
GENOTYPE_PRED_COL    = "predicted_genotype"
...
def main():
    ...
    # sanity keys
    for k in [CELLTYPE_TRUTH_COL, GENOTYPE_TRUTH_COL, CELLTYPE_PRED_COL, GENOTYPE_PRED_COL]:
        if k not in adata.obs.columns:
            raise KeyError(f"Missing obs column: {k}")
    for k in [CELLTYPE_PROB_KEY, GENOTYPE_PROB_KEY]:
