...
save_dir = Path(f"/local/projects-t3/lilab/vmenon/Pert-TF-model/dev_celltype_{dataset_name}-{time.strftime('%b%d-%H-%M')}/")
...
holdout_mask = (
    (adata.obs["celltype"].str.contains("Ductal|ESC|SC-EC", regex=True, na=False))
)
