...
random_indices = random.sample(range(adata0.n_obs), min(3000, adata0.n_obs))
adata0 = adata0[random_indices]
logger.info(f"Reduced AnnData: n_obs={adata0.n_obs}, n_vars={adata0.n_vars}")
